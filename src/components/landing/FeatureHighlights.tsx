      ...
      >
        <div className="max-w-3xl mx-auto px-6 py-12 rounded-2xl bg-gradient-to-br from-white/50 to-white/30 backdrop-blur-lg border border-white/40 shadow-xl">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Everything is free forever. Resume tailoring automatically uses the next available permitted free provider when a provider is unavailable.
          </p>
          ...
          <p className="text-sm text-muted-foreground mt-6 flex items-center justify-center gap-2">
            ...
            Free forever • No subscriptions • No credits • No upgrade required
          </p>
        </div>
      </motion.div>
