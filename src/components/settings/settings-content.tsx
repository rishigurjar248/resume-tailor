...
const sections = [
  ...
  { id: "free-forever", title: "Free Forever", description: "No subscriptions or credits", icon: "🆓" },
  ...
  return (
    <div className="flex gap-8 relative">
      ...
      <div className="flex-1 space-y-8">
        ...
        {/* Free Forever */}
        <Card id="free-forever" className="border-white/40 shadow-xl shadow-black/5 bg-white/80 backdrop-blur-xl">
          <CardHeader><CardTitle className="text-xl">Free Forever</CardTitle><CardDescription>All resume and AI features are available without subscriptions or credits.</CardDescription></CardHeader>
          <CardContent><p className="text-sm text-muted-foreground">AI requests use configured free providers and automatically fail over when a provider is unavailable or rate limited.</p></CardContent>
        </Card>
