          ...
          <div className="p-3 rounded-lg bg-amber-50/50 border border-amber-200/50 text-amber-900 text-sm">
            {isProPlan ? (
              ...
              <>
                ...
                <p className="mt-1">For app-funded model access, <a href="/home" className="text-amber-700 hover:text-amber-800 underline underline-offset-2">use Pro</a> instead of entering a personal key.</p>
              </>
            )}
          </div>
        </div>
